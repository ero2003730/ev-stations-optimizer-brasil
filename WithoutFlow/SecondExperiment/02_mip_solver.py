...
def main():
    ...
    df_new.to_parquet(OUTPUT_DIR / "sites_new_mip_experiment5.parquet", index=False)
    print(f"✓ sites_new_mip_experiment5.parquet salvo — {num_new} estações")
